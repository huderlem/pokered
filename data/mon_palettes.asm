MonsterPalettes:
	...
	db PAL_BLUEMON   ; TAILLOW
	db PAL_BLUEMON   ; SWELLOW
	db PAL_BLUEMON   ; WINGULL
	db PAL_BLUEMON   ; PELIPPER
	db PAL_GREENMON  ; RALTS
	db PAL_GREENMON  ; KIRLIA
	db PAL_GREENMON  ; GARDEVOIR
	db PAL_BLUEMON   ; SURSKIT
	db PAL_BLUEMON   ; MASQUERAIN
	db PAL_BROWNMON  ; SHROOMISH
	db PAL_BROWNMON  ; BRELOOM
	db PAL_BROWNMON  ; SLAKOTH
	db PAL_GREYMON   ; VIGOROTH
	db PAL_BROWNMON  ; SLAKING
	db PAL_GREYMON   ; NINCADA
	db PAL_GREYMON   ; NINJASK
	db PAL_BROWNMON  ; SHEDINJA
	db PAL_PURPLEMON ; WHISMUR
	db PAL_PURPLEMON ; LOUDRED
	db PAL_PURPLEMON ; EXPOUD
	db PAL_YELLOWMON ; MAKUHITA
	db PAL_BROWNMON  ; HARIYAMA
	db PAL_BLUEMON   ; AZURILL
	db PAL_BLUEMON   ; NOSEPASS
	db PAL_PINKMON   ; SKITTY
	db PAL_PURPLEMON ; DELCATTY
	db PAL_PURPLEMON ; SABLEYE
	db PAL_GREYMON   ; MAWILE
	db PAL_GREYMON   ; ARON
	db PAL_GREYMON   ; LAIRON
	db PAL_GREYMON   ; AGGRON
	db PAL_BLUEMON   ; MEDITITE
	db PAL_REDMON    ; MEDICHAM
